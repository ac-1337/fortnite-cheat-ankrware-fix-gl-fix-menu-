namespace Offsets 
{
	...
	uintptr_t RecoilHoriz = 0x210;
	uintptr_t RecoilVert = 0x200;
	uintptr_t RecoilDownsightsMultiplier = 0x22C;
	uintptr_t LastReloadTime = 0xA14;
	uintptr_t TargetPawn = 0x2A0;
	uintptr_t localplayerstate = 0x328;
	uintptr_t LastSuccessfulReloadTime = 0xA18;
